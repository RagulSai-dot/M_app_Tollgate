  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        canvasColor: Color.fromARGB(255, 146, 199, 40),
        fontFamily: 'OpenSans',
      ),
      home: LoginPage(),
      routes: {
        ...
        '/fastag': (context) =>
            FastagPage(), // New route for FASTag services page
      },
    );
  }
}
...
class Dashboard extends StatelessWidget {
  ...
  Widget _buildDashboardButton(BuildContext context, String text, IconData icon,
                ...
                showDialog(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      ...
                      content: Text(
                          'Paid \$${amount} at ${location} using $_selectedPaymentMethod.'),
                      actions: [
                        TextButton(
            ...
            case 1:
              return _buildFastagSection(
                ...
                child: Row(
                  ...
                  children: [
                    _buildFastagButton(
                        Icons.account_balance_wallet, 'UPI Recharge'),
                    _buildFastagButton(
                        Icons.account_balance, 'Wallet Recharge'),
              ...
              return _buildFastagSection(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    _buildFastagButton(
                        Icons.add_circle_outline, 'Create FASTag Wallet'),
                    _buildFastagButton(Icons.account_balance_wallet,
                        'Access Your FASTag Wallet'),
                  ],
                ),
              );
            case 3:
